...
//         backgroundColor: AppColors.primaryColor,
//         icon:
//             const Icon(Icons.mic_rounded, color: AppColors.whiteColor),
//         label: Text(
//           'New Recording',
//           style: GoogleFonts.poppins(
//             color: AppColors.whiteColor,
...
//                   shape: BoxShape.circle,
//                 ),
//                 child: const Icon(Icons.voice_chat_rounded,
...
//               SizedBox(height: size.customHeight(context) * 0.005),
//               Obx(() => Text(
//                     '${controller.filteredSubmissions.length} '
//                     'submission${controller.filteredSubmissions.length != 1 ? 's' : ''}',
//                     style: GoogleFonts.poppins(
//                       color: AppColors.whiteColor.withOpacity(0.9),
//                       fontSize: size.customWidth(context) * 0.035,
//                     ),
...
//     final hasResults = submission.hasResults();
//     final result = submission.getLatestResult();
//     final analysisResult = result?.result;
...
//                           SizedBox(
//                               height:
//                                   size.customHeight(context) * 0.003),
//                           Row(
//                             children: [
...
//                             Get.toNamed(AppRoutes.speechDetail,
//                                 arguments:
//                                     submission.speechSubmissionId);
//                           }),
//                         ),
//                         PopupMenuItem(
//                           child: Row(children: [
...
//               ElevatedButton.icon(
//                 onPressed: () =>
//                     Get.toNamed(AppRoutes.speechRecording),
//                 style: ElevatedButton.styleFrom(
//                   backgroundColor: AppColors.primaryColor,
//                   padding: EdgeInsets.symmetric(
//                     horizontal: size.customWidth(context) * 0.08,
...
//       BuildContext context, String submissionId) {
//     final size = CustomSize();
...
class _SpeechSubmissionsScreenState extends State<SpeechSubmissionsScreen> {
  // ✅ Always reuse the permanent singleton — never call Get.put here
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Container(
                ...
                child: TextField(
                  // ✅ Use the same controller from the permanent singleton
                  controller: controller.searchController,
                  onChanged: controller.searchSubmissions,
                  style: GoogleFonts.poppins(
                    fontSize: size.customWidth(context) * 0.04,
              ...
              sliver: SliverList(
                delegate: SliverChildBuilderDelegate(
                  (context, index) => _buildSubmissionCard(
                      context, controller.filteredSubmissions[index]),
                  childCount: controller.filteredSubmissions.length,
                ),
              ),
            );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: size.customHeight(context) * 0.005),
              Obx(() => Text(
                    '${controller.filteredSubmissions.length} submission'
  ...
  Widget _buildSubmissionCard(
    ...
    return Container(
      ...
      child: Material(
        color: Colors.transparent,
        child: InkWell(
          onTap: () => Get.toNamed(AppRoutes.speechDetail,
              arguments: submission.speechSubmissionId),
          borderRadius: BorderRadius.circular(20),
          child: Padding(
            padding: EdgeInsets.all(size.customWidth(context) * 0.04),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: hasResults && analysisResult != null
                              ? [
                                  _riskColor(analysisResult).withOpacity(0.7),
                                  _riskColor(analysisResult),
                                ]
                              : [
                                  AppColors.greyColor.withOpacity(0.3),
                        ...
                        children: [
                          Text(submission.getChildName(),
                              style: GoogleFonts.poppins(
                                  ...
                                  color: AppColors.textPrimaryColor)),
                          SizedBox(
                              height: size.customHeight(context) * 0.003),
                          Row(children: [
                            Icon(Icons.access_time_rounded,
                                size: 14,
                                color: AppColors.textSecondaryColor),
                            SizedBox(width: size.customWidth(context) * 0.01),
                            Text('${submission.recordingDurationSeconds}s',
                                style: GoogleFonts.poppins(
                                    fontSize:
                                        size.customWidth(context) * 0.032,
                                    color: AppColors.textSecondaryColor)),
                            ...
                            Icon(Icons.calendar_today_outlined,
                                ...
                                color: AppColors.textSecondaryColor),
                            SizedBox(width: size.customWidth(context) * 0.01),
                            Text(submission.getFormattedDate(),
                                style: GoogleFonts.poppins(
                                    fontSize:
                                        size.customWidth(context) * 0.032,
                                    color: AppColors.textSecondaryColor)),
                  ...
                  Row(children: [
                        ...
                        children: [
                          Text(analysisResult.riskInterpretation,
                              style: GoogleFonts.poppins(
                                  ...
                                  color: _riskColor(analysisResult))),
                          SizedBox(
                              height: size.customHeight(context) * 0.006),
                          ClipRRect(
                            borderRadius: BorderRadius.circular(6),
                            child: LinearProgressIndicator(
                              value: analysisResult.severityScore /
                                  analysisResult.maxScore,
                              backgroundColor:
                                  _riskColor(analysisResult).withOpacity(0.15),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            color:
                                _riskColor(analysisResult).withOpacity(0.4)),
                      ),
                      child: Text(
                        '${analysisResult.severityScore}/${analysisResult.maxScore}',
                        style: GoogleFonts.poppins(
