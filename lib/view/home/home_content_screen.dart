        ...
        child: Column(
          ...
          children: [
            ...
            _buildScreeningCard(
              ...
              icon: Icons.assignment_outlined,
              title: 'Structured Questionnaire',
              subtitle: 'Answer behavioral & developmental questions',
              number: '1',
              onTap: () => Get.toNamed(AppRoutes.patientInfo),
            ),
            ...
            _buildScreeningCard(
              ...
              icon: Icons.mic_outlined,
              title: 'Voice Sample Analysis',
              subtitle: 'Record and analyze your child\'s speech',
              number: '2',
              onTap: () => Get.toNamed(AppRoutes.speechRecording),
            ),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            '• Early identification leads to more effective support and better outcomes',
            style: GoogleFonts.poppins(
              fontSize: size.customWidth(context) * 0.032,
              color: AppColors.textPrimaryColor,
              height: 1.6,
