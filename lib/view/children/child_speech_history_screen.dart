// // lib/view/children/child_speech_history_screen.dart
// import 'package:flutter/material.dart';
// import 'package:get/get.dart';
// import 'package:google_fonts/google_fonts.dart';
// import 'package:speechspectrum/constants/app_colors.dart';
// import 'package:speechspectrum/constants/custom_size.dart';
// import 'package:speechspectrum/controllers/child_speech_history_controller.dart';
// import 'package:speechspectrum/models/speech_models.dart';
// import 'package:speechspectrum/routes/app_routes.dart';

// class ChildSpeechHistoryScreen extends StatefulWidget {
//   const ChildSpeechHistoryScreen({super.key});

//   @override
//   State<ChildSpeechHistoryScreen> createState() =>
//       _ChildSpeechHistoryScreenState();
// }

// class _ChildSpeechHistoryScreenState
//     extends State<ChildSpeechHistoryScreen> {
//   late final ChildSpeechHistoryController controller;
//   late String childId;
...
//     controller = Get.put(
//       ChildSpeechHistoryController(),
//       tag: childId,
//     );

//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       controller.fetchAndFilterSpeech(childId);
//     });
//   }

//   @override
//   void dispose() {
//     Get.delete<ChildSpeechHistoryController>(tag: childId);
//     super.dispose();
//   }
...
//               Obx(() => Text(
//                     '${controller.filteredSubmissions.length} recording'
...
//         child: InkWell(
//           onTap: () => Get.toNamed(
//             AppRoutes.childSpeechDetail,
//             arguments: {
//               'submissionId': submission.speechSubmissionId,
//               'childName': childName,
//             },
//           ),
//           borderRadius: BorderRadius.circular(20),
...
//                       decoration: BoxDecoration(
//                         gradient: LinearGradient(
//                           colors: hasResults && analysisResult != null
//                               ? [
//                                   _riskColor(analysisResult)
//                                       .withOpacity(0.7),
//                                   _riskColor(analysisResult),
//                                 ]
//                               : [
...
//                             SizedBox(
//                                 width:
//                                     size.customWidth(context) * 0.01),
//                             Text(
//                               '${submission.recordingDurationSeconds}s  •  ${submission.getFormattedTime()}',
//                               style: GoogleFonts.poppins(
//                                 fontSize:
...
//                   ],
//                 ),
//                 if (hasResults && analysisResult != null) ...[
//                   SizedBox(height: size.customHeight(context) * 0.015),
//                   Divider(
...
//                               fontWeight: FontWeight.w600,
//                               color: _riskColor(analysisResult),
//                             ),
//                           ),
//                           SizedBox(
//                               height:
//                                   size.customHeight(context) * 0.006),
//                           ClipRRect(
//                             borderRadius: BorderRadius.circular(6),
//                             child: LinearProgressIndicator(
//                               value: analysisResult.severityScore /
//                                   analysisResult.maxScore,
//                               backgroundColor: _riskColor(analysisResult)
//                                   .withOpacity(0.15),
...
//                       ),
//                       decoration: BoxDecoration(
//                         color: _riskColor(analysisResult).withOpacity(0.1),
//                         borderRadius: BorderRadius.circular(20),
//                         border: Border.all(
//                             color: _riskColor(analysisResult)
//                                 .withOpacity(0.4)),
...
//   risk_level, severity_percentage, sa_score  (from AnalysisResult new format)
// Falls back gracefully to old format (severity_score / max_score).
...
class _ChildSpeechHistoryScreenState
  ...
  Widget _buildCard(
    ...
    final bool isNewFormat =
        analysisResult != null && analysisResult.saScore != null;
    final String scoreLabel = isNewFormat
        ? analysisResult!.saScore!.toStringAsFixed(2)
        : (analysisResult != null
            ? '${analysisResult.severityScore}/${analysisResult.maxScore}'
            : '');
    final String severityLabel = isNewFormat
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                              height:
                                  size.customHeight(context) * 0.006),
                          // Progress bar: new format uses saScore/22, old uses severityScore/maxScore
                          ClipRRect(
                            borderRadius: BorderRadius.circular(6),
                            child: LinearProgressIndicator(
                              value: isNewFormat
                                  ? (analysisResult.saScore! / 22.0)
                                      .clamp(0.0, 1.0)
                          ...
                          if (isNewFormat && severityLabel.isNotEmpty) ...[
                            SizedBox(
                                height:
                            ...
                            Text(
                              ...
                              style: GoogleFonts.poppins(
                                fontSize:
                                    size.customWidth(context) * 0.028,
                                color: _riskColor(analysisResult),
                                fontWeight: FontWeight.w500,
                              ),
                            ),
