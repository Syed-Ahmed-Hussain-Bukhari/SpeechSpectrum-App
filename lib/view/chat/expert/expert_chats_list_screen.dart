// lib/view/expert/expert_chats_list_screen.dart
...
class ExpertChatsListScreen extends StatefulWidget {
  const ExpertChatsListScreen({super.key});
...
class _ExpertChatsListScreenState extends State<ExpertChatsListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.fetchExpertConversations();
    });
  }
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () => controller.fetchExpertConversations(),
                          icon: Icon(
                            Icons.refresh,
                            color: AppColors.whiteColor,
                            size: size.customWidth(context) * 0.06,
          ...
          Expanded(
            child: Obx(() {
              ...
              return RefreshIndicator(
                onRefresh: () => controller.fetchExpertConversations(),
                color: AppColors.primaryColor,
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Center(
                child: Text(
                  conversation.expertChildLinks.children.getInitials(),
                  style: GoogleFonts.poppins(
                    color: AppColors.whiteColor,
