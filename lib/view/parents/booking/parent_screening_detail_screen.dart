// lib/view/parents/booking/parent_screening_detail_screen.dart
import 'dart:io';
...
class ParentScreeningDetailScreen extends StatefulWidget {
  const ParentScreeningDetailScreen({super.key});

  @override
  State<ParentScreeningDetailScreen> createState() =>
      _ParentScreeningDetailScreenState();
}

class _ParentScreeningDetailScreenState
    extends State<ParentScreeningDetailScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          Obx(() {
            ...
            final hasResult =
                item != null && item.questionnaireResults.isNotEmpty;
        ...
        children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text('The screening analysis is being processed.',
                      style: GoogleFonts.poppins(
          ...
          _sectionCard(
            ...
            children: [
              ...
              _divider(),
              _infoRow('Age (Months)',
                  '${item.responses['Age_Mons'] ?? 'N/A'}', Icons.cake_outlined),
              _divider(),
              _infoRow('Gender',
                  item.responses['Sex'] == 1 ? 'Male' : 'Female',
                  Icons.wc_outlined),
