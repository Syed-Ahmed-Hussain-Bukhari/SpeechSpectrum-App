...
// class _ParentSpeechDetailScreenState extends State<ParentSpeechDetailScreen> {
...
// //
// // CHANGES vs original:
// //   • Now uses ParentSpeechController (new) instead of ExpertChildDataController.
// //   • fetchSpeechDetail receives item.speechSubmissionId which is now guaranteed
// //     non-empty because ParentSpeechService parses 'speech_submission_id' correctly.
// //   • All UI is 100% identical to original — only the controller/model references changed.
// //
// import 'dart:io';
// import 'dart:typed_data';
// import 'package:flutter/material.dart';
...
// import 'package:speechspectrum/services/parent_speech_service.dart'; // NEW models
...
//   late final ParentSpeechController _ctrl; // changed from ExpertChildDataController
//   late final String _submissionId;
//   late final String _childName;
...
//     // Use the dedicated parent speech controller
...
//       if (_submissionId.isNotEmpty) {
//         debugPrint(
//             '🚀 [ParentSpeechDetail] initState — fetching detail for "$_submissionId"');
//         _ctrl.fetchSpeechDetail(_submissionId);
//       } else {
//         debugPrint('⚠️ [ParentSpeechDetail] submissionId is EMPTY — cannot fetch');
//       }
//     });
//   }
...
//                   pw.SizedBox(height: 4),
//                   _pdfRow(
//                       'Risk Level', analysisResult.riskInterpretation),
//                   pw.SizedBox(height: 4),
//                   _pdfRow('Severity Score',
//                       '${analysisResult.severityScore} / ${analysisResult.maxScore}'),
//                   pw.SizedBox(height: 4),
