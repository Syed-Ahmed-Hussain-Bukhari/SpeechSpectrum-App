...
class ExpertsListScreen extends StatefulWidget {
  /// Set to true when this screen is embedded inside HomeScreen via bottom nav.
  /// This hides the back arrow since there is no screen to go back to.
  final bool fromBottomNav;

  const ExpertsListScreen({super.key, this.fromBottomNav = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.whiteColor,
        elevation: 0,
        // Hide back arrow when accessed from bottom navigation tab
