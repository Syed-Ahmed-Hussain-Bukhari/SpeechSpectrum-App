...
class OnboardingScreen extends StatelessWidget {
  ...
  final List<OnboardingData> pages = [
    OnboardingData(
      title: 'Early Screening Made Simple',
      description:
          'Every child develops at their own pace. SpeechSpectrum helps parents notice early speech and communication delays using simple questions and short voice recordings.',
      image: 'assets/images/onboarding1.jpg',
      gradient: const [Color(0xFF6C5CE7), Color(0xFF9B8DE7)],
    ),
    OnboardingData(
      title: 'Smart AI-Powered Screening',
      description:
          'Our AI analyzes speech patterns and behavioral responses to highlight possible autism-related risks, supporting early awareness and timely professional consultation.',
      image: 'assets/images/onboarding2.jpg',
      gradient: const [Color(0xFF74B9FF), Color(0xFF0984E3)],
    ),
    OnboardingData(
      title: 'Support That Guides You Forward',
      description:
          'Get clear insights, helpful guidance, and recommendations for next steps. Designed to support parents and assist therapists in early intervention planning.',
  ...
  Widget _buildPage(OnboardingData data, BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          /// Image (no background, no circle)
          Image.asset(
            data.image,
            height: size.customHeight(context) * 0.32,
            fit: BoxFit.contain,
          ),
  ...
  Widget _buildDot(int index, int currentPage, BuildContext context) {
    ...
    return AnimatedContainer(
      duration: const Duration(milliseconds: 300),
      margin:
          EdgeInsets.symmetric(horizontal: size.customWidth(context) * 0.01),
      height: size.customHeight(context) * 0.01,
