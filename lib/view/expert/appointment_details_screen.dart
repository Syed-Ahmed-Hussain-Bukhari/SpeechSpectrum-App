// // lib/view/expert/appointment_details_screen.dart
...
//           SizedBox(height: size.customHeight(context) * 0.008),
//           Text(
//             'Session notes will appear here after the appointment',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final details = controller.appointmentDetails.value;
        if (details == null) {
          return _buildErrorState(context, 'Failed to load appointment details');
        }
