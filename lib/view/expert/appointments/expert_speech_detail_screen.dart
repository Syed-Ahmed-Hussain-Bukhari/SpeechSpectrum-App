...
//                 height: size.customWidth(context) * 0.42,
//                 child: CircularProgressIndicator(
//                   value: (r.displayScore / r.displayMaxScore)
//                       .clamp(0.0, 1.0),
//                   strokeWidth: 10,
//                   backgroundColor: riskColor.withOpacity(0.15),
//                   valueColor: AlwaysStoppedAnimation<Color>(riskColor),
...
class _ExpertSpeechDetailScreenState
  ...
  Future<void> _generatePdf(ExpertSpeechItem item) async {
    ...
    try {
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.SizedBox(height: 10),
                  _pdfRow('Child Name',
                      _childName.isNotEmpty ? _childName : 'N/A'),
                  pw.SizedBox(height: 4),
      ...
      final Uint8List bytes = await pdf.save();
      final dir = await getApplicationDocumentsDirectory();
      final childSafe = _childName.isNotEmpty
          ? _childName.replaceAll(RegExp(r'[^\w]'), '_')
          : 'report';
      final file = File(
          '${dir.path}/Speech_Report_${childSafe}_$_submissionId.pdf');
      await file.writeAsBytes(bytes);
