...
class _ExpertChildProfileScreenState extends State<ExpertChildProfileScreen>
  ...
  // ── PDF: Speech (updated — no severity/model fields) ─────────────────────
      ...
      pdf.addPage(
        pw.MultiPage(
          ...
          build: (pw.Context ctx) => [
            ...
            // Result summary — no severity/model
            pw.Container(
              padding: const pw.EdgeInsets.all(16),
              decoration: pw.BoxDecoration(
                border:
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  _pdfRow('Child', _childName),
                  pw.SizedBox(height: 4),
                  _pdfRow('Risk Level', analysisResult.displayRiskLabel),
                  pw.SizedBox(height: 4),
                  _pdfRow('Date', item.formattedDate),
                  pw.SizedBox(height: 4),
                  _pdfRow('Time', item.formattedTime),
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                // ── Result row (risk badge only, no score bar) ────────────
                if (hasResult && analysisResult != null) ...[
                  SizedBox(height: size.customHeight(context) * 0.012),
                  Divider(
                      height: 1,
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              analysisResult.displayRiskLabel,
                              style: GoogleFonts.poppins(
                                  fontSize: 12.5,
                                  fontWeight: FontWeight.w700,
                                  color: riskColor),
                            ...
                            ClipRRect(
                              borderRadius: BorderRadius.circular(6),
                              child: LinearProgressIndicator(
                                value: (analysisResult.displayScore /
                                        analysisResult.displayMaxScore)
                                    .clamp(0.0, 1.0),
                                backgroundColor:
                                    riskColor.withOpacity(0.15),
                                valueColor: AlwaysStoppedAnimation<Color>(
                      ...
                      Container(
                        ...
                        child: Text(
                          analysisResult.isNewFormat
                              ? '${analysisResult.saScore!.toStringAsFixed(1)}/${analysisResult.displayMaxScore}'
                              : '${analysisResult.severityScore ?? 0}/${analysisResult.displayMaxScore}',
                          style: GoogleFonts.poppins(
                              fontSize: 12,
                              fontWeight: FontWeight.bold,
                              color: riskColor),
