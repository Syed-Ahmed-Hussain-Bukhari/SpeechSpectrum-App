...
//               // ── SCHEDULED: Payment status card ───────────────
//               if (appt.isScheduled) ...[
//                 _buildPaymentStatusCard(context, size, appt),
//                 SizedBox(height: size.customHeight(context) * 0.018),
//               ],

//               // ── CONFIRMED: Meeting link card ─────────────────
//               if (appt.isConfirmed &&
//                   appt.meetLink != null &&
...
//   // ── Header with payment badge for scheduled ────────────────
//   Widget _buildHeaderBackground(
//     BuildContext context,
//     CustomSize size, {
//     required String initials,
...
//     required _StatusMeta meta,
//   }) {
//     final isScheduledStatus = status.toLowerCase() == 'scheduled';
...
//                           ),
//                         const SizedBox(height: 8),
//                         // Status badge + payment badge row
//                         Wrap(
//                           spacing: 6,
//                           runSpacing: 4,
//                           children: [
...
//   // ── Payment status card (Scheduled appointments only) ──────
...
//               children: [
//                 Icon(
//                   isPaid ? Icons.circle : Icons.error_outline_rounded,
//                   size: 14,
//                   color:
//                       isPaid ? AppColors.successColor : AppColors.warningColor,
//                 ),
...
//                     isPaid
//                         ? 'Paid ✓'
//                         : 'Pending — patient has not paid yet',
//                     style: GoogleFonts.poppins(
//                       fontSize: 13,
//                       fontWeight: FontWeight.w600,
//                       color: isPaid
...
//           // If not paid, show an info note for the expert
//           if (!isPaid) ...[
//             SizedBox(height: size.customHeight(context) * 0.008),
//             Container(
//               padding:
...
//   // ── Meeting link card (Confirmed appointments only) ────────
//   Widget _buildMeetLinkCard(
//       BuildContext context, CustomSize size, String url) {
//     return GestureDetector(
//       onTap: () {
//         // Expert can copy the link; opening is optional
//       },
//       child: Container(
...
//   /// Confirm dialog — warns if payment is still pending
//   void _showConfirmDialog(BuildContext context, MyAppointmentItem appt) {
//     if (appt.isPaymentPending) {
//       // Payment pending: show warning dialog first
//       showDialog(
//         context: context,
//         barrierDismissible: false,
//         builder: (_) => _PaymentPendingConfirmDialog(
//           appt: appt,
//           onConfirmAnyway: () {
//             // User acknowledged the unpaid state and wants to confirm anyway
//             _doConfirm(context, appt.appointmentId);
//           },
//         ),
//       );
//     } else {
//       // Payment is paid: straight confirm
//       showDialog(
//         context: context,
//         barrierDismissible: false,
//         builder: (_) => _ActionDialog(
...
//           icon: Icons.check_circle_outline_rounded,
//           onConfirm: () async {
//             final ok = await _c.confirmAppointment(appt.appointmentId);
//             return ok;
//           },
//           onSuccess: () {
//             _c.pendingTabIndex.value = 2;
//             Navigator.pop(context);
//             Get.back();
//           },
//         ),
...
//   /// Runs the actual confirm API after user acknowledged the unpaid warning.
//   void _doConfirm(BuildContext context, String appointmentId) {
//     showDialog(
//       context: context,
//       barrierDismissible: false,
//       builder: (_) => _ActionDialog(
//         title: 'Confirm Appointment?',
//         message: 'Payment is still pending. Are you sure you want to confirm?',
//         confirmLabel: 'Yes, Confirm',
//         confirmColor: AppColors.primaryColor,
//         icon: Icons.check_circle_outline_rounded,
//         onConfirm: () async {
//           final ok = await _c.confirmAppointment(appointmentId);
//           return ok;
//         },
//         onSuccess: () {
//           _c.pendingTabIndex.value = 2;
...
// // ══════════════════════════════════════════════════════════════
// // Payment pending warning dialog shown before confirming
// // when patient has not paid yet
// // ══════════════════════════════════════════════════════════════
// class _PaymentPendingConfirmDialog extends StatelessWidget {
//   final MyAppointmentItem appt;
//   final VoidCallback onConfirmAnyway;

//   const _PaymentPendingConfirmDialog({
//     required this.appt,
//     required this.onConfirmAnyway,
//   });
...
//                 shape: BoxShape.circle),
//             child: const Icon(Icons.warning_amber_rounded,
//                 color: AppColors.warningColor, size: 36),
//           ),
//           const SizedBox(height: 16),
//           Text(
...
//                     const SizedBox(width: 8),
//                     Text(
//                       'Amount due: ${appt.currency} ${appt.feeCharged.toStringAsFixed(0)}',
//                       style: GoogleFonts.poppins(
//                           fontSize: 13,
//                           fontWeight: FontWeight.w600,
//                           color: AppColors.warningColor),
...
//                     Expanded(
//                       child: Text(
//                         'The patient has not completed payment yet. Are you sure you want to confirm this appointment?',
//                         style: GoogleFonts.poppins(
//                             fontSize: 12,
//                             color: AppColors.warningColor.withOpacity(0.85)),
//                       ),
...
//                     onConfirmAnyway(); // proceed to confirm
//                   },
//                   style: ElevatedButton.styleFrom(
//                     backgroundColor: AppColors.primaryColor,
//                     foregroundColor: Colors.white,
...
//               // ── CONFIRMED: Meeting link card — OPENS URL ─────
//               if (appt.isConfirmed &&
//                   appt.meetLink != null &&
//                   appt.meetLink!.isNotEmpty) ...[
//                 _buildMeetLinkCard(context, size, appt.meetLink!),
...
//   // ── Meeting link card (Confirmed) — NOW OPENS URL ──────────
//   Widget _buildMeetLinkCard(
//       BuildContext context, CustomSize size, String url) {
//     return GestureDetector(
//       onTap: () => _openUrl(url),
...
//         builder: (_) => _PaymentPendingConfirmDialog(
//           appt: appt,
//           onConfirmAnyway: () => _doConfirm(context, appt.appointmentId),
//         ),
//       );
//     } else {
//       showDialog(
...
// // ══════════════════════════════════════════════════════════════
// // Payment pending warning dialog
// // ══════════════════════════════════════════════════════════════
// class _PaymentPendingConfirmDialog extends StatelessWidget {
//   final MyAppointmentItem appt;
//   final VoidCallback onConfirmAnyway;
...
//                     Expanded(
//                       child: Text(
//                         'The patient has not completed payment yet. Are you sure you want to confirm?',
//                         style: GoogleFonts.poppins(
//                             fontSize: 12,
//                             color: AppColors.warningColor.withOpacity(0.85)),
//                       ),
