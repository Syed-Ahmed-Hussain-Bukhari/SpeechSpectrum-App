...
// // lib/view/expert/appointments/my_appointments_screen.dart
// // UPDATED — "Recent" highlighted section at top of All tab (based on created_at within 7 days)
// import 'package:flutter/material.dart';
// import 'package:flutter/services.dart';
// import 'package:get/get.dart';
// import 'package:google_fonts/google_fonts.dart';
...
//           controller: _tab,
//           children: [
//             // All tab — uses special builder with Recent section
//             _buildAllTabList(context, size, _c.allAppointments),
//             _buildList(context, size, _c.scheduledList,
//                 showDateBadge: true, showChildProfileBtn: true),
//             _buildList(context, size, _c.confirmedList,
//                 showChildProfileBtn: true),
...
//   // ══════════════════════════════════════════════════════════════
//   // ALL TAB — with Recent section at the top
//   // ══════════════════════════════════════════════════════════════
...
//               context,
//               size,
//               label: recentList.isNotEmpty
//                   ? 'All Appointments'
//                   : 'All Appointments',
//               icon: Icons.list_alt_rounded,
//               color: AppColors.textSecondaryColor,
//               subtitle: '${olderList.length} appointment${olderList.length == 1 ? '' : 's'}',
//               isRecent: false,
//             ),
//             SizedBox(height: size.customHeight(context) * 0.012),
//             ...olderList.map(
...
//           // Edge case: everything is recent, no older section
//           if (recentList.isNotEmpty && olderList.isEmpty)
//             Padding(
//               padding: EdgeInsets.only(top: size.customHeight(context) * 0.004),
//               child: Center(
//                 child: Text(
...
//   // ══════════════════════════════════════════════════════════════
//   // Other tab list builders (unchanged)
//   // ══════════════════════════════════════════════════════════════
...
//   // ══════════════════════════════════════════════════════════════
//   // Appointment card — now accepts isRecentHighlight
//   // ══════════════════════════════════════════════════════════════
...
//           color: AppColors.whiteColor,
//           borderRadius: BorderRadius.circular(20),
//           // Recent cards get a subtle left accent border + stronger shadow
...
//         child: Column(
//           children: [
//             // Top color strip — thicker + glow for recent
//             Container(
...
//   // ── Recent label (e.g. "2 hours ago", "3 days ago") ───────
//   String _recentLabel(MyAppointmentItem appt) {
//     try {
//       final created = DateTime.parse(appt.createdAt).toLocal();
//       final diff = DateTime.now().difference(created);
...
//   // ── All helper widgets (100% same as before) ──────────────
...
// // lib/view/expert/appointments/my_appointments_screen.dart
// // UPDATED — "Recent" highlighted section at top of ALL tabs (based on created_at within 7 days)
// import 'package:flutter/material.dart';
// import 'package:flutter/services.dart';
// import 'package:get/get.dart';
// import 'package:google_fonts/google_fonts.dart';
...
//             // All tab
//             _buildSectionedList(
//               context, size, _c.allAppointments,
//               showDateBadge: false,
//               showChildProfileBtn: true,
//               isExpiredTab: false,
//             ),
...
//         ),
//         children: [
//           // ── Expired banner (Expired tab only, shown at top) ──
//           if (isExpiredTab) ...[
...
class MyAppointmentsScreen extends StatefulWidget {
  // ── CHANGE 1: added fromBottomNav param ───────────────────────────────────
  /// Set to true when this screen is embedded inside the bottom-nav host
  /// (ExpertMainScreen). This hides the back arrow in the AppBar.
  final bool fromBottomNav;

  const MyAppointmentsScreen({super.key, this.fromBottomNav = false});
  // ─────────────────────────────────────────────────────────────────────────
...
class _MyAppointmentsScreenState extends State<MyAppointmentsScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: AppColors.lightGreyColor,
      // ── CHANGE 2: hide back arrow when opened from bottom nav ─────────────
      appBar: AppBar(
        backgroundColor: AppColors.whiteColor,
        elevation: 0,
        surfaceTintColor: Colors.transparent,
