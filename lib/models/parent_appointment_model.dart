...
// ============================================================================
// PARENT APPOINTMENTS MODELS (with expertUsers included)
// ============================================================================

class ParentAppointmentsModel {
  final String message;
  final List<ParentAppointmentItem> data;
  final bool status;

  ParentAppointmentsModel({
    required this.message,
    required this.data,
    required this.status,
  });

  factory ParentAppointmentsModel.fromJson(Map<String, dynamic> json) {
    return ParentAppointmentsModel(
      message: json['message'] ?? '',
      data: (json['data'] as List<dynamic>?)
              ?.map((item) => ParentAppointmentItem.fromJson(item))
              .toList() ??
          [],
...
class ParentAppointmentItem {
  ...
  final ParentExpertChildLinks expertChildLinks;
  ...
  factory ParentAppointmentItem.fromJson(Map<String, dynamic> json) {
    return ParentAppointmentItem(
      appointmentId: json['appointment_id'] ?? '',
      appointmentType: json['appointment_type'] ?? '',
      scheduledAt: json['scheduled_at'] ?? '',
      status: json['status'] ?? '',
      createdAt: json['created_at'] ?? '',
      expertChildLinks: ParentExpertChildLinks.fromJson(json['expert_child_links']),
    );
  }
...
class ParentExpertChildLinks {
  final String linkId;
  final String childId;
  final AppointmentChildInfo children;
  final String expertId;
  final ExpertUserInfo expertUsers; // THIS IS THE KEY DIFFERENCE
  final String parentUserId;

  ParentExpertChildLinks({
  ...
  factory ParentExpertChildLinks.fromJson(Map<String, dynamic> json) {
    return ParentExpertChildLinks(
      linkId: json['link_id'] ?? '',
...
// ============================================================================
// EXPERT APPOINTMENTS MODELS (without expertUsers)
// ============================================================================
...
// ============================================================================
// APPOINTMENT DETAILS MODEL (used by both parent and expert)
// ============================================================================
...
// ============================================================================
// OTHER MODELS (Create Appointment, Zoom, etc.)
// ============================================================================
