...
class MyAppointmentItem {
  ...
  // ── Expiry helper ──────────────────────────────────────────
  /// True when scheduledAt is in the past (regardless of status).
  /// Only meaningful for scheduled / confirmed appointments —
  /// completed, cancelled and no_show ignore this flag in the UI.
  bool get isExpired {
    try {
      return DateTime.parse(scheduledAt).isBefore(DateTime.now());
    } catch (_) {
      return false;
    }
  }
