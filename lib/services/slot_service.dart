...
//     // ── Duplicate overlap constraint ───────────────────────
//     if (data is Map) {
//       final msg = (data['message'] ?? '').toString();
//       if (msg.contains('no_overlap') ||
//           msg.contains('duplicate key') ||
//           msg.contains('overlap')) {
//         return 'A slot already exists at this time. Please choose a different time or date.';
//       }
...
//       );
//       debugPrint('✅ Zoom link generated');
//       return ZoomLinkResult.fromJson(
//           response.data['data'] as Map<String, dynamic>);
//     } on DioException catch (e) {
//       debugPrint('❌ Zoom link error: ${e.response?.data}');
//       throw Exception(_errorMessage(e, 'Failed to generate Zoom link'));
//     }
//   }
...
//       debugPrint('📅 Fetching my slots');
//       final response =
//           await _dio.get(APIEndPoints.mySlots, options: await _auth());
//       debugPrint(
//           '✅ Slots fetched: ${(response.data['data'] as List?)?.length ?? 0}');
//       return SlotListModel.fromJson(
//           response.data as Map<String, dynamic>);
//     } on DioException catch (e) {
//       throw Exception(_errorMessage(e, 'Failed to fetch slots'));
//     }
//   }
...
//       );
//       debugPrint('✅ Slot created');
//       return SlotSingleModel.fromJson(
//           response.data as Map<String, dynamic>);
//     } on DioException catch (e) {
//       debugPrint('❌ Create slot error: ${e.response?.data}');
//       throw Exception(_errorMessage(e, 'Failed to create slot'));
//     }
//   }
...
//           response.data as Map<String, dynamic>);
//     } on DioException catch (e) {
//       throw Exception(_errorMessage(e, 'Failed to update slot'));
//     }
//   }
...
//       return true;
//     } on DioException catch (e) {
//       throw Exception(_errorMessage(e, 'Failed to delete slot'));
//     }
//   }
// }
