...
//   var answers = <int, int>{}.obs; // stores the selected option index
//   var selectedChildId = ''.obs;
//   var selectedChildName = ''.obs; // ← NEW: store child name for result screen
//   var ageMonths = 0.obs;
//   var selectedGender = 1.obs; // 1 = male, 0 = female
//   var hasJaundice = 0.obs; // 0 = no, 1 = yes
//   var hasFamilyASD = 0.obs; // 0 = no, 1 = yes
...
//     answers.clear();
//     selectedChildId.value = '';
//     selectedChildName.value = ''; // ← NEW: reset child name
//     ageMonths.value = 0;
//     selectedGender.value = 1;
//     hasJaundice.value = 0;
//     hasFamilyASD.value = 0;
...
class QuestionnaireController extends GetxController {
  ...
  var answers = <int, int>{}.obs; // stores the selected option index
  var selectedChildId = ''.obs;
  var selectedChildName = ''.obs; // store child name for result & expert screens
  var ageMonths = 0.obs;
  var selectedGender = 1.obs; // 1 = male, 0 = female
  var hasJaundice = 0.obs; // 0 = no, 1 = yes
  var hasFamilyASD = 0.obs; // 0 = no, 1 = yes
  ...
  int getScoreForOption(int questionIndex, int optionIndex) {
    ...
    // For other questions: Always/Usually/Many times = 1, rest = 0
    return optionIndex <= 1 ? 1 : 0;
  }
  ...
  Future<void> submitQuestionnaire() async {
    ...
    try {
      ...
      // Navigate to results screen
      // selectedChildName is already set from patient_info_screen when child was selected
      Get.offAllNamed(AppRoutes.questionnaireResults);
    } catch (e) {
      Get.snackbar(
        'Error',
